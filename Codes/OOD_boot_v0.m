function OOD_boot_v0(isubj, nNoise, SF, nBoot, flag_estimateThresh, flag_binData, flag_filterData)
...
% parfor iLocNoise = iLocNoise_all % more interested in L6-9
    ...
    if isempty(ccc_full)
        ...
        %------------------------------------------------%
        ccc_full(ccc_full(:, 3)>100/100, 3)=100/100; % limit the cst of trials to be within 100%
