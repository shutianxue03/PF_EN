...
%   release R2023b, the first release to run natively on Silicon chip. See
%   https://www.palamedestoolbox.org/forum/viewtopic.php?t=16
%
%PAL_PFHB_buildStan:
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Version 1.11.11 Release November 24, 2023
%
% Purpose: introduce the beta probability density function (PAL_pdfBeta) 
%  and the ex-Gaussian probability function (PAL_pdfExGaussian). 
%  Introduction of PAL_pdfBeta allows us to put a beta prior on parameters 
%  in demos (Matlab's 'betapdf' function is in the 'statistics and machine 
%  learning' toolbox and, as such, would not be available to all users). 
%  PAL_AMPM_Demo.m in the PalamedesDemos folder now puts a beta prior on 
%  the lapse rate. 
%
%PAL_pdfBeta:
