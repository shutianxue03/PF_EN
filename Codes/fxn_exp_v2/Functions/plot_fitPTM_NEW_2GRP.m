...
nCol = 6;
    ...
    h1=ploterr_wp(X_interest,10.^(stats_KC70.avg),[],{10.^errors_KC70.low,10.^errors_KC70.up},'^','logxy'); hold on;
...
%     set(gcf,'color','w','Position',[5 5 50 50])
    ...
    h1=ploterr_wp(X_interest,10.^(stats_KC79.avg),[],{10.^errors_KC79.low,10.^errors_KC79.up},'^','logxy'); hold on;
    set(h1,'MarkerSize',8,'MarkerEdgeColor',colorCond(2,:),'color',colorCond(2,:),'Linewidth',1.5)
