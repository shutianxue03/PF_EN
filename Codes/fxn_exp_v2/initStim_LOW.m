...
% the only difference: SF=1.5 cpd
...
params.gaborfrequency   = 1.5/visual.ppd;
...
params.startLvl         = log10([.02 .5 .02 .5]);
params.stairRule        = [ 3  3    2  2];
params.stairStep        = [.2 .1 .05];
params.nTrialsPerStair  = 9;

params.catchLvl         = log10([.01 1]);
params.nTrialsCatch     = 2; % # of catch trials / condition;
